...
class EditStudentUseCase  (private val plannerRepository: PlannerRepository) {

    suspend operator fun invoke(student: Student) = plannerRepository.editStudent(student)
}